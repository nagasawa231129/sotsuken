...
<html lang="ja">
    ...
    <div class="container">
        ...
        <div class="cart-items">
            ...
            if($dbh){
                // カート内の商品の情報を取得
                $sql = "SELECT shop_id, quantity FROM cart";
                ...
                if($result === false){
                    ...
                    foreach ($cartItems as $shopId => $item) {
                        ...
                        if($stmt->rowCount() > 0){
                            ...
                            echo "<button class='decrease-btn' data-shop-id='$shopId' data-price='$price' data-quantity='" . $item['quantity'] . "' onClick='updateQuantityHandler(this)'>-</button>";
                            echo " <span id='quantity_$shopId'>" . $item['quantity'] .  "</span> ";
                            echo "<button class='increase-btn' data-shop-id='$shopId' data-price='$price' data-quantity='" . $item['quantity'] . "' onClick='updateQuantityHandler(this)'>+</button>";
