...
WHERE subcategory.subcategory_name =  'ジャンパースカート'";
            ...
            <ul class="category-list">
                ...
                <li class="category-item">
                    ...
                    <ul class="sub-category">
                        ...
                        <li><a href="jumper-skirt.php">ジャンパースカート</a></li>
                        <li><a href="onepiece-dress.php">ワンピース</a></li>
                        <li><a href="pants-dress.php">パンツドレス</a></li>
                        <li><a href="shirts-onepiece.php">シャツワンピース</a></li>
                        <li><a href="tunic.php">チュニック</a></li>
                    </ul>
                </li>
            </ul>
        </aside>
