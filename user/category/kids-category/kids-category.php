...
<body>
    <div class="container">
        ...
        <nav class="tabs">
            ...
            <a href="kids-category.php?gender=3" class="tab-button <?php echo basename($_SERVER['PHP_SELF']) == 'kids-category.php' ? 'active' : ''; ?>" data-target="kids"><?php echo $translations['Kids'] ?></a>
        </nav>
