    ...
    <div class="container">
        ...
        <body>
            <nav class="tabs">
                ...
                <a href="men-category.php" class="tab-button <?php echo basename($_SERVER['PHP_SELF']) == 'men-category.php' ? 'active' : ''; ?>" data-target="men">メンズ</a>
                <a href="../woman-category/woman-category.php" class="tab-button <?php echo basename($_SERVER['PHP_SELF']) == '../woman-category/woman-category.php' ? 'active' : ''; ?>" data-target="woman">レディース</a>
                <a href="../kids-category/kids-category.php" class="tab-button <?php echo basename($_SERVER['PHP_SELF']) == '../kids-category/kids-category.php' ? 'active' : ''; ?>" data-target="kids">キッズ</a>
            </nav>
