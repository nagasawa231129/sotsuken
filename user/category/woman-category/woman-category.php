...
<body>
    <div class="container">
        ...
        <nav class="tabs">
            ...
            <a href="woman-category.php?gender=woman" class="tab-button <?php echo basename($_SERVER['PHP_SELF']) == 'woman-category.php' ? 'active' : ''; ?>" data-target="woman"><?php echo $translations['Ledies'] ?></a>
