...
<body>
    <div class="container">
        ...
        <nav class="tabs">
            ...
            <a href="../men-category/men-category.php?gender=1" class="tab-button <?php echo basename($_SERVER['PHP_SELF']) == '../men-category/men-category.php' ? 'active' : ''; ?>"  data-target="men"><?php echo $translations['Mens'] ?></a>
            <a href="woman-category.php?gender=2" class="tab-button <?php echo basename($_SERVER['PHP_SELF']) == 'woman-category.php' ? 'active' : ''; ?>" data-target="woman"><?php echo $translations['Ledies'] ?></a>
