...
WHERE subcategory.subcategory_name =  'ミリタリージャケット'";
        ...
        <aside class="sidebar">
            ...
            <ul class="category-list">
                ...
                <li class="category-item">
                    ...
                    <ul class="sub-category">
                        <li><a href="collarless-coat.php">ノーカラーコート</a></li>
                        <li><a href="collarless-jacket.php">ノーカラージャケット</a></li>
                        <li><a href="denim-jacket.php">デニムジャケット</a></li>
                        <li><a href="down-jacket.php">ダウンジャケット</a></li>
                        <li><a href="down-vest.php">ダウンベスト</a></li>
                        <li><a href="duffle-coat.php">ダッフルコート</a></li>
                        <li><a href="jacket.php">ブルゾン</a></li>
                        <li><a href="military-jacket.php">ミリタリージャケット</a></li>
                        <li><a href="mods-coat.php">モッズコート</a></li>
                        <li><a href="nylon-jacket.php">ナイロンジャケット</a></li>
                        <li><a href="riders-jacket.php">ライダースジャケット</a></li>
                        <li><a href="tailored-jacket.php">テーラードジャケット</a></li>
                        <li><a href="trench-coat.php">トレンチコート</a></li>
                        <li><a href="auter-jacket.php">その他アウター</a></li>
                    </ul>
                </li>
                <li class="category-item">
                ...
                <li class="category-item">
                    ...
                    <ul class="sub-category">
                        ...
                        <li><a href="../skirt/long-skirt.php">ロングスカート</a></li>
