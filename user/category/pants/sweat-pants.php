...
WHERE subcategory.subcategory_name = 'スウェットパンツ'";
        ...
        <aside class="sidebar">
            ...
            <ul class="category-list">
                ...
                <li class="category-item">
                    ...
                    <ul class="sub-category">
                        <li><a href="cargo-pants.php">カーゴパンツ</a></li>
                        <li><a href="chino-pants.php">チノパン</a></li>
                        <li><a href="denim-pants.php">デニムパンツ</a></li>
                        <li><a href="slacks.php">スラックス</a></li>
                        <li><a href="sweat-pants.php">スウェットパンツ</a></li>
                        <li><a href="auter-pants.php">その他パンツ</a></li>
                    </ul>
                </li>
                <li class="category-item">
