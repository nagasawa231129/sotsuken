...
$sql = "SELECT shop.*, brand.*, sale.*
        ...
        WHERE subcategory.subcategory_name =  'ミディスカート'";
...
<body>
    <div class="main-content">
        ...
        <h2 data-i18n="search"><?php echo $translations['Search'] ?></h2>
            ...
            <li class="category-item">
                ...
                <li class="category-item">
                    ...
                    <ul class="sub-category">
                        <li><a href="mini-skirt.php" data-i18n="mini-skirt"><?php echo $translations['Mini Skirt'] ?></a></li>
                        <li><a href="midi-skirt.php" data-i18n="midi-skirt"><?php echo $translations['Midi Skirt'] ?></a></li>
                        <li><a href="long-skirt.php" data-i18n="long-skirt"><?php echo $translations['Long Skirt'] ?></a></li>
                        <li><a href="denim-skirt.php" data-i18n="denim-skirt"><?php echo $translations['Denim Skirt'] ?></a></li>
                    </ul>
                </li>
                <li class="category-item">
        ...
        <div class="products-section">
            ...
            <h1><?php echo $translations['Midi Skirt'] ?></h1>
